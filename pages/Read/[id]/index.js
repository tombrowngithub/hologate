    ...
    return (
        <div className="h-screen dark:bg-black">
            <div
                ...
                <Link className="flex items-center text-white bg-indigo-800 h-full p-2 dark:bg-[#2d2d2d]" href="/"><ArrowLeftIcon
                ...
                <div className=" ">
                    <AdjustmentsHorizontalIcon className="w-7 text-indigo-900 active:text-white dark:text-white"/>
                </div>
            </div>
